...
class DaumPostcodeSearch extends StatefulWidget {
  ...
  final void Function(InAppWebViewController controller, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse)? onReceivedHttpError;
  final void Function(InAppWebViewController controller, WebResourceRequest webResourceRequest, WebResourceError webResourceError)? onReceivedError;
  ...
  final Future<PermissionResponse?> Function(InAppWebViewController controller, PermissionRequest permissionRequest)? onPermissionRequest;
  ...
  DaumPostcodeSearch({
    ...
    this.assetPath = "packages/daum_postcode_search/lib/assets/daum_search.html",
